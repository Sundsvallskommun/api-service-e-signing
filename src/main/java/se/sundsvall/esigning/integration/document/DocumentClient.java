...
public interface DocumentClient {
	...
	@GetMapping(path = "/documents/{registrationNumber}", produces = {APPLICATION_JSON_VALUE, APPLICATION_PROBLEM_JSON_VALUE})
	Document getDocument(@PathVariable(name = "registrationNumber") final String registrationNumber);
